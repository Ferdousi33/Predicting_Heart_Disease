...
## Overview
This project applies supervised machine learning techniques to predict risk-scores from clinical features. It compares multiple models, points out contributing features, calculates risk score and provides visualization for performance and interpretability of the model. This is the used [dataset](dataset/heart-disease.csv).
